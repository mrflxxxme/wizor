...
**Не делегируй:** тривиальная правка (1 файл, < 50 строк) — быстрее `Edit` напрямую; архитектурное решение — суб-агент предлагает, founder/architect решают; final approve/merge (только founder tier 3+).
