...
## 2. 17 проектных решений (decision log харнесса)
...
| 10 | Git/PR/CI | **Лёгкий PR-на-фазу + тированные CI-гейты**; founder — единственный человек-апрувер tier 3+ | ADR-0009 |
...
9. **PR + аппрув** (founder) — tier-based; founder аппрувит tier 3+; tier 1–2 авто-мердж на зелёном CI; squash-merge.
...
*Charter v1.0 · 2026-06-23 · источник истины для всех build-агентов WIZOR. Изменения — только через ADR.*
